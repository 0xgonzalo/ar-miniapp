  ...
  export async function GET() {
    ...
    const manifest = {
      ...
      miniapp: {
        ...
        subtitle: "Augmented Reality art on Base",
        description: 'Augmented Reality art on Base',
        tags: ['art', 'augmented-reality', 'base'],
        primaryCategory: 'art-creativity',
        heroImageUrl: `${URL}/icon.png`,
        tagline: "Experience Augmented Reality",
        ogTitle: "AR Mini App",
        ogDescription: "Augmented Reality art on Base",
